...
(function ($, window, document, undefined) {
  ...
  Plugin.prototype = {
    ...
    _defineElements: function () {
      ...
      self.$scrollOffset =
        self.$scrollElement.data("scrollie-offset") ||
        self.$scrollElement.data("scrollie-offset") == "0"
          ? self.$scrollElement.data("scrollie-offset")
          : self.settings.scrollOffset;
      ...
      self.$scrollRatio =
        ...
        self.$scrollElement.data("scrollie-scrollRatio") == "0"
          ? self.$scrollElement.data("scrollie-scrollRatio")
          : self.settings.scrollRatio;
    },
    _inMotion: function (winPos, winHeight, thisTop, direction) {
      ...
      if (movingToTheTop) {
        ...
        jQuery.isFunction(self.settings.scrollingToTheTop) &&
          self.settings.scrollingToTheTop.call(
            this,
            this.$scrollElement,
            self.$scrollOffset,
            direction,
      ...
      if (movingThrough) {
        //revised and offset complete
        jQuery.isFunction(self.settings.scrollingInView) &&
          self.settings.scrollingInView.call(
            this,
            this.$scrollElement,
            self.$scrollOffset,
            direction,
      ...
      if (atTheTop) {
        //revised and offset complete
        jQuery.isFunction(self.settings.scrollingOutOfView) &&
          self.settings.scrollingOutOfView.call(
            this,
            this.$scrollElement,
            self.$scrollOffset,
            direction,
       ...
       *---------------------------------------------------*/
      if (!movedOut) {
        jQuery.isFunction(self.settings.scrolledOutOfView) &&
          self.settings.scrolledOutOfView.call(
            this,
            this.$scrollElement,
            self.$scrollOffset,
            direction,
